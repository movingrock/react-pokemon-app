    ...
    <div className="relative z-50">
      ...
      >
        <input
          ...
          className="text-xs w-[20.5rem] h-6 px-2 py-1 rounded-lg bg-slate-500 text-gray-300 text-center"
        />
      ...
      {checkEqualName(searchTerm).length > 0 && (
        ...
        >
          ...
          ></div>
          <ul
            className={`w-40 max-h-[134px] py-2 bg-gray-700 rounded-lg absolute top-0 overflow-auto scrollbar-none`}
          >
